/****** Object:  StoredProcedure [dbo].[wDescarcBonSP]    Script Date: 08/01/2013 16:09:35 ******/
SET ANSI_NULLS ON
GO
...
begin
	if DATEDIFF(second, @dataStart, getdate()) >= 6000 and APP_NAME() not like '%Microsoft SQL Server%' 
