--***
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'yso_pdocTVACumpAdoc') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	DROP FUNCTION yso_pdocTVACumpAdoc
GO
--***
