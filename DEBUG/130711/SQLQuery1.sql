drop procedure [dbo].[wDescarcBonSP]
GO

--***
create procedure [dbo].[wDescarcBonSP] @sesiune varchar(50), @parXML xml
as
/*sp
				...
				*/
				...
				BEGIN
					SELECT TOP 1
						...
						@GestSt=/*sp (case when @TipDoc='AC' then rtrim(@GestBon)
									else ';'+replace(@listaGestiuniPozitie, @GestBon+';', '')+';'+rtrim(@GestBon)+';' end), 
								--aceasta atribuire cred ca ar fi dat eroare de gest inexistenta in cazul @TipDoc<>'AC' sp*/p.gestiune,
