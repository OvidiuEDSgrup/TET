--***
--IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'jurnalTVACumparari') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
	DROP procedure yso_pjurnalTVACumparari
GO 
--***
...
select @DataJ, @DataS, @ContF, @Gest, @LM, @LMExcep, @Jurnal, @ContCor, @TVAnx, @RecalcBaza, @nTVAex, @FFFBTVA0, @SFTVA0, @IAFTVA0, @TipCump,
					@TVAAlteCont, @DVITertExt, @OrdDataDoc, @Tert, @Factura, @UnifFact, 0, @nTVAned, @parXML
insert @vert
