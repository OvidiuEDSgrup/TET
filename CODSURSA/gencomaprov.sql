...
(case when 0=1 then isnull((select top 1 p.codfurn from ppreturi p where p.tip_resursa='C' and p.cod_resursa = a.cod and p.tert = a.furnizor and p.data_pretului<='02/02/2012' order by p.data_pretului desc), '')
 else '' end)  as explicatii,
0      as numar_pozitie,
'OVIDIU'     as utilizator,
'02/02/2012'     as data_operarii,
'162851'     as ora_operarii
from comaprovtmp a
inner join nomencl n on n.cod = a.cod
--left outer join ppreturi p on 0=1 and p.tip_resursa='C' and p.cod_resursa = a.cod and p.tert = a.furnizor
where a.utilizator='OVIDIU    ' and a.de_aprovizionat>0
and not exists (select * from pozcon b where b.subunitate='1        ' and b.tip='FC' and b.contract='0                   ' and b.tert=a.furnizor and b.cod=a.cod and b.data='02/02/2012' and b.numar_pozitie=0)
