...
select @datainf='2012-04-01', @datasup='2012-04-30'
...
left((case when b.Factura_chitanta=1 then rtrim(convert(varchar(4),b.Casa_de_marcat))+right(replace(str(b.Numar_bon),' ','0'),4) else ltrim(b.Factura) end),8)
--) 
		and p.Data=b.Data and p.Cod=b.Cod_produs
