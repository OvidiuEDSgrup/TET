...
CREATE UNIQUE CLUSTERED INDEX [Unic]
    ON [dbo].[fisalans]([Terminal] ASC, [Comanda] ASC, [Cod_produs] ASC, [Cod_parinte] ASC, [Numar_material] ASC, [Cod_material] ASC, [Loc_de_munca] ASC, [Culoare_produs] ASC, [Culoare_material] ASC);


GO
CREATE NONCLUSTERED INDEX [Culoare_material]
    ON [dbo].[fisalans]([Terminal] ASC, [Comanda] ASC, [Cod_material] ASC, [Culoare_material] ASC, [Loc_de_munca] ASC);
