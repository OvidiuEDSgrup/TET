...
GO
CREATE UNIQUE CLUSTERED INDEX [KEY_TSTEMP_3103300]
    ON [dbo].[TEMP_3103300]([TS] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [KEY001TEMP_3103300]
    ON [dbo].[TEMP_3103300]([TMPFLD13] DESC, [TS] ASC);
