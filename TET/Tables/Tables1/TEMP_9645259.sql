...
GO
CREATE UNIQUE CLUSTERED INDEX [KEY_TSTEMP_9645259]
    ON [dbo].[TEMP_9645259]([TS] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [KEY001TEMP_9645259]
    ON [dbo].[TEMP_9645259]([TMPFLD13] DESC, [TS] ASC);
