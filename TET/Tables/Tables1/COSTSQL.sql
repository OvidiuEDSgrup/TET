...
CREATE UNIQUE CLUSTERED INDEX [princ]
    ON [dbo].[COSTSQL]([DATA] ASC, [LM_SUP] ASC, [COMANDA_SUP] ASC, [ART_SUP] ASC, [LM_INF] ASC, [COMANDA_INF] ASC, [ART_INF] ASC, [CANTITATE] ASC, [VALOARE] ASC, [Tip] ASC, [Numar] ASC);


GO
CREATE NONCLUSTERED INDEX [Pentru_fisa]
    ON [dbo].[COSTSQL]([ART_INF] ASC, [LM_INF] ASC, [COMANDA_INF] ASC);
