...
CREATE UNIQUE CLUSTERED INDEX [Principal]
    ON [dbo].[fisa_tehn]([Hostid] ASC, [Cod_produs] ASC, [Cod_reper] ASC, [Cod_operatie] ASC, [Loc_de_munca] ASC, [Tip_utilaj] ASC, [Numar_operatie] ASC);


GO
CREATE NONCLUSTERED INDEX [Loc_de_munca]
    ON [dbo].[fisa_tehn]([Hostid] ASC, [Cod_produs] ASC, [Cod_reper] ASC, [Cod_operatie] ASC, [Loc_de_munca] ASC);


GO
CREATE NONCLUSTERED INDEX [Pentru_fisa]
    ON [dbo].[fisa_tehn]([Hostid] ASC, [Cod_produs] ASC, [Cod_operatie] ASC, [Cod_material] ASC);
