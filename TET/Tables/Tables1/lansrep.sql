...
CREATE UNIQUE CLUSTERED INDEX [Principal]
    ON [dbo].[lansrep]([Subunitate] ASC, [Comanda] ASC, [Cod_tata] ASC, [Cod_material] ASC, [Numar_fisa] ASC);


GO
CREATE NONCLUSTERED INDEX [Comanda_Tip_Cod]
    ON [dbo].[lansrep]([Subunitate] ASC, [Comanda] ASC, [Cod_produs] ASC, [Tip_reper_mat] ASC, [Cod_material] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [Pe_locm]
    ON [dbo].[lansrep]([Subunitate] ASC, [Comanda] ASC, [Cod_tata] ASC, [Loc_de_munca] ASC, [Tip_reper_mat] ASC, [Cod_material] ASC, [Numar_fisa] ASC);
