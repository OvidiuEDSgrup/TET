...
GO
CREATE UNIQUE CLUSTERED INDEX [KEY_TSTEMP_0751860]
    ON [dbo].[TEMP_0751860]([TS] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [KEY001TEMP_0751860]
    ON [dbo].[TEMP_0751860]([TMPFLD13] DESC, [TS] ASC);
