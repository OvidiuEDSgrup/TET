...
CREATE UNIQUE CLUSTERED INDEX [CombiSerii]
    ON [dbo].[combin]([Terminal] ASC, [Gestiune] ASC, [Cod] ASC, [Cod_intrare] ASC, [Culoare] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [Culoare]
    ON [dbo].[combin]([Terminal] ASC, [Gestiune] ASC, [Cod] ASC, [Culoare] ASC, [Cod_intrare] ASC);


GO
CREATE NONCLUSTERED INDEX [_WA_Sys_Culoare_4D5F7D71]
    ON [dbo].[combin]([Culoare] ASC);


GO
CREATE NONCLUSTERED INDEX [_WA_Sys_Cod_intrare_4D5F7D71]
    ON [dbo].[combin]([Cod_intrare] ASC);


GO
CREATE NONCLUSTERED INDEX [_WA_Sys_Cod_4D5F7D71]
    ON [dbo].[combin]([Cod] ASC);


GO
CREATE NONCLUSTERED INDEX [_WA_Sys_Gestiune_4D5F7D71]
    ON [dbo].[combin]([Gestiune] ASC);
