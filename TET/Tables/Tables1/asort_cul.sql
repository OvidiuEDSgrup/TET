...
CREATE UNIQUE CLUSTERED INDEX [Structura]
    ON [dbo].[asort_cul]([Hostid] ASC, [Cod_produs] ASC, [Numar_material] ASC);


GO
CREATE NONCLUSTERED INDEX [Principal]
    ON [dbo].[asort_cul]([Hostid] ASC, [Cod_produs] ASC, [Cod_material] ASC, [Loc_de_munca] ASC);
