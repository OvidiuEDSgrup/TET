...
**/
CREATE PROCEDURE [dbo].[tet_rapFormTransferAm] @sesiune VARCHAR(50), @tip varchar(2), @numar varchar(20), @data datetime,
								   @parXML varchar(max)
AS
begin try 
...
begin catch
	set @mesaj = ERROR_MESSAGE()+ ' (tet_rapFormTransferAm)'
	raiserror(@mesaj, 11, 1)
end catch

/*
	exec tet_rapFormTransferAm @sesiune='', @tip='RM', @numar='97', @data='2013-06-30'
*/