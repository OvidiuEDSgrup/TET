...
*--*/--n.Grupa,
insert Expval
(Cod_indicator,Tip,Data,Element_1,Element_2,Element_3,Element_4,Element_5,Valoare)
select 'VMB','E'
,c.DATA_LUNII
...
,sum(p.Cantitate*p.Pret_vanzare-p.Cantitate*isnull(pk.pret_intrare_pachet,p.Pret_de_stoc)) 
...
--EXPANDEZ({c.DATA_LUNII},{pp.echipa},{lm.denumire},{t.denumire},{isnull(g.denumire,'FARA')},{n.denumire})
