...
from webconfigSTDGrid w left join webconfigSTDmeniu m on w.meniu=m.meniu where (@meniu is null or w.meniu=@meniu) and (w.tip=@tip or @tip='' or isnull(m.TipMacheta,'')='C') and (w.subtip=@subtip or @subtip='')
