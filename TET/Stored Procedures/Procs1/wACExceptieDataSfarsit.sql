--***
Create procedure wACExceptieDataSfarsit @sesiune varchar(50), @parXML XML
as
Begin
	...
	from CatalogRevisal
	where TipCatalog='ExceptieDataSfarsit' and (cod like @searchText+'%' or descriere like '%'+@searchText+'%')
	order by cod
	for xml raw
End	
