--***
create procedure wACFacturi @sesiune varchar(50), @parXML XML  
as  
...
if exists (select 1 from sysobjects where [type]='P' and [name]='wACFacturiSP') -- procedura inlocuitoare
	exec wACFacturiSP @sesiune, @parXML 
else
begin
	if exists (select 1 from sysobjects where [type]='P' and [name]='wACFacturiSP1') -- procedura complementara 
		exec wACFacturiSP1 @sesiune, @parXML output
