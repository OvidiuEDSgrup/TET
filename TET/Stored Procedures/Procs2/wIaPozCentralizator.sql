--***
create procedure wIaPozCentralizator  @sesiune varchar(30), @parXML XML
as
if exists (select 1 from sysobjects where [type]='P' and [name]='wIaPozCentralizatorSP')
begin 
	declare @returnValue int 
	exec @returnValue = wIaPozCentralizatorSP @sesiune, @parXML output
	return @returnValue
end
...
select distinct top 100  rtrim(pc.contract) as comanda,
						 ...
						 rtrim(@tip) as tip,
						 'CI' as subtip,
						 RTRIM(max(t.denumire)) as dentert,
			...
			inner join terti t on t.Tert=pc.Tert
