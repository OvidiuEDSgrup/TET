--***
create procedure wIaMotiveService @sesiune varchar(50), @parXML XML
as
if exists(select * from sysobjects where name='wIaMotiveServiceSP' and type='P')
	exec wIaMotiveServiceSP @sesiune, @parXML 
else      
begin
