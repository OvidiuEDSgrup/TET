--***
create procedure [dbo].[wIaCatopSA] @sesiune varchar(50), @parXML XML
as
if exists(select * from sysobjects where name='wIaCatopSASP' and type='P')
	exec wIaCatopSASP @sesiune, @parXML 
else      
begin
