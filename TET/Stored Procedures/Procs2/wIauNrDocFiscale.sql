...
declare 
	...
	@meniu varchar(20), @subtip varchar(2), @data datetime
...
if not exists (select 1 from docfiscale where TipDoc=@TipDocument and ISNULL(meniu,'')=ISNULL(@meniu,'') and ISNULL(subtip,'')=ISNULL(@subtip,''))
begin
...
begin try
	...
	and
		(@data IS NULL or @data between ISNULL(NULLIF(d.dela,'1900-01-01 00:00:00.000'),'1901-01-01') and ISNULL(NULLIF(d.panala,'1900-01-01 00:00:00.000'),'2901-01-01'))
