...
--***
CREATE PROCEDURE wIaPozplin @sesiune VARCHAR(50), @parXML XML
AS
...
IF OBJECT_ID('wIaPozplinSP') IS NOT NULL
BEGIN
	EXEC wIaPozplinSP @sesiune, @parXML
END
ELSE
BEGIN
