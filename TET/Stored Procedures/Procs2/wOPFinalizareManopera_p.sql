--*** Populare operatie cu grid pentru finalizarea manoperei ***
create procedure wOPFinalizareManopera_p @sesiune varchar(50), @parXML xml
as
begin try
	declare
		@nrdeviz varchar(20), @detaliiManopera xml
	...
	select @detaliiManopera for xml path('DateGrid'), root('Mesaje')
