--***
create procedure wOPReincadrareIesiriPtSQL2005 @sesiune varchar(50), @parXML xml                
as              
...
begin try
	...
	inner join 
		...
		from #stoctotal s1
		group by s1.Tip_gestiune,s1.Cod_gestiune,s1.Cod) sm on s1.Tip_gestiune=sm.Tip_gestiune and s1.Cod_gestiune=sm.Cod_gestiune and s1.Cod=sm.Cod and s1.nrord=sm.nrord
