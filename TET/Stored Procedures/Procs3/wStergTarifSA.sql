--***
create procedure wStergTarifSA @sesiune varchar(50), @parXML xml
as
begin try
...
set @mesajeroare=(case /*when exists (select 1 from pozdevauto where cod=@cod) then 
...
if @mesajeroare=''
	delete from tarifemanopera where cod=@cod
else 
