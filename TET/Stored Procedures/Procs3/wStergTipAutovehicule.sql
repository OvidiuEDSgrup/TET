--***
create procedure wStergTipAutovehicule @sesiune varchar(50), @parXML xml
as
begin try
...
set @mesajeroare=(case when exists (select 1 from auto where Tip_auto=@cod) then 
...
if @mesajeroare=''
	delete from tipauto where cod=@cod
else
