--***
create procedure wScriuPDserii @Tip char(2), @Numar char(8), @Data datetime, @Gestiune char(9), @Cod char(20), @CodIntrare char(13), @NumarPozitie int, @Serie char(20), @Cantitate float, @GestiunePrimitoare char(9)
as
