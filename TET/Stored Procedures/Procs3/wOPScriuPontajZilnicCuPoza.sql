...
CREATE procedure wOPScriuPontajZilnicCuPoza @sesiune varchar(50), @parXML XML
as
begin try
...
begin catch
	set @mesaj = ERROR_MESSAGE() + ' (wOPScriuPontajZilnicCuPoza)'+'(linia '+convert(varchar(20),ERROR_LINE())+') :'
