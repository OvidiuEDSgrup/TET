--***
Create procedure wOPScriuPontajZilnicCuPoza_p @sesiune varchar(50), @parXML xml
as
...
begin try  
	...
	select 1500 as inchideininterval for xml raw,root('Mesaje')	
end try  

begin catch  
	--ROLLBACK TRAN
	declare @eroare varchar(254) 
	set @eroare='(wOPScriuPontajZilnicCuPoza_p) '+ERROR_MESSAGE()
