create PROCEDURE [dbo].[wUAIaContracte]  
 @sesiune [varchar](50),  
 @parXML [xml]  
...
set transaction isolation level READ UNCOMMITTED  
 ...
 Declare  @filtrucodabonat varchar(30),@filtrucontract varchar(30),@filtrudenabonat varchar(30),@filtruzona varchar(30),@filtrulocal varchar(30),
	@filtrustrada varchar(30),@utilizator char(10), @userASiS varchar(20)
select   
...
c.tip_contract as tipcontract,(case when tip_contract='UC' then 'Contract' else 'Comanda' end) as dentipc,
...
convert(decimal(12,0),c.categorie_penalizare) as categpen,rtrim(p.denumire) as dencategpret,

(case when c.stare in ('3','4')  then '#FF0000' else (case when tip_contract='UK' then '#2600ff' else '#000000' end) end) as culoare  
