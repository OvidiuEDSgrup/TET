...
CREATE PROCEDURE wOPStornareBon_p @sesiune varchar(50), @parXML XML
AS
begin try
	...
	select 
		...
		@lm=dbo.wfProprietateUtilizator('LOCMUNCA',@utilizator),
...
begin catch
	...
	set @mesaj=ERROR_MESSAGE()+ ' (wOPStornareBon_p)'
