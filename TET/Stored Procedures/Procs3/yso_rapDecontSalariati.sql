create proc yso_rapDecontSalariati (@cData datetime,@marca nvarchar(4000),@decont nvarchar(4000),@cont nvarchar(4000),@ptrulaj nvarchar(1),@ptfisa nvarchar(1),@datajos nvarchar(4000),@datasus nvarchar(4000),@dDataScadJos nvarchar(4000),@dDataScadSus nvarchar(4000),@pe_sold nvarchar(1),@plecati int) as
...
select @cData='2012-04-05 00:00:00',@marca=NULL,@decont=NULL,@cont=NULL,@ptrulaj=N'0',@ptfisa=N'0',@datajos=NULL,@datasus=NULL,@dDataScadJos=NULL,@dDataScadSus=NULL,@pe_sold=N'1',@plecati=2
