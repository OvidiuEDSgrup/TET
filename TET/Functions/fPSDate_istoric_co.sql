--***
/**	functie pentru date istoric Concedii de odihna */
Create
function [dbo].[fPSDate_istoric_co] (@Datajos datetime, @Datasus datetime, @lLocm int, @pLocm char(9), @lStrict int, 
