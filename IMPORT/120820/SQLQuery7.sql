...
--begin try -- scriu nomenclator
	declare @fisier nvarchar(4000) set @fisier='\\10.0.0.10\import\80_ASIS_import_pachete_20 august_2012_DC.xlsx'
	...
	select distinct cod, note, denumire, tip, grupa, um, furnizor, codvamal, pret, pret_stocn, pretvanznom, cont, cotatva
	into #nomenclXlsDifTmp
	from #nomenclXlsTmp 
	except
	select			cod, note, denumire, tip, grupa, um, furnizor, codvamal, pret, pret_stocn, pretvanznom, cont, cotatva
	from yso_vIaNomencl
