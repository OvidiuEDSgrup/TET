...
--/*
if exists (select * from sysobjects where name ='yso_xScriuTabela')
drop procedure yso_xScriuTabela
go
...
exec yso_xScriuTabela 'pozcon', '\\10.0.0.10\import\testimport.xlsx'
