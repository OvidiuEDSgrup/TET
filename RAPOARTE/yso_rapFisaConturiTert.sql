/*
declare @cFurnBenef varchar(1),@cDataJos datetime,@cDataSus datetime,@cTert varchar(50),@cContTert varchar(40),@grupa varchar(50),
	@exc_grupa varchar(50),@cFactura varchar(40),@grfact varchar(40),@lm varchar(40),@comanda varchar(40),@cont_cor varchar(40),
	@tipinc varchar(40),@dataAnt datetime,@indicator varchar(40),@detTVA varchar(1),@ordonare int
select @cFurnBenef='',@cDataJos='01/01/2000',@cDataSus='07/31/2014', @cContTert=null, @ordonare=1
exec yso_rapFisaConturiTert @cFurnBenef=@cFurnBenef,@cDataJos=@cDataJos,@cDataSus=@cDataSus, @cContTert=null, @ordonare=1
*/

/**	Procedura folosita de raportul CG/Contabilitate/Fisa cont tert*/
--***
if exists (select 1 from sysobjects where name='yso_rapFisaConturiTert' and xtype='P')
drop procedure yso_rapFisaConturiTert
GO
--***
