...
exec rapFisaContTert @cFurnBenef=@cFurnBenef, @cDataJos=@cDataJos, @cDataSus=@cDataSus, @cTert=@cTert, @cContTert=@cContTert,
	...
	@cont_cor=@cont_cor, @tipinc=@tipinc, @indicator=@indicator, @detTVA=@detTVA, @ordonare=@ordonare',N'@cFurnBenef nvarchar(1),@cDataJos datetime,@cDataSus datetime,@cTert nvarchar(4000),@cContTert nvarchar(3),@grupa nvarchar(4000),@exc_grupa nvarchar(4000),@cFactura nvarchar(4000),@grfact nvarchar(4000),@lm nvarchar(4000),@comanda nvarchar(4000),@cont_cor nvarchar(4000),@tipinc nvarchar(4000),@indicator nvarchar(4000),@detTVA nvarchar(1),@ordonare nvarchar(1)',@cFurnBenef=N'B',@cDataJos='2013-01-01 00:00:00',@cDataSus='2013-12-30 00:00:00',@cTert='RO6602668',@cContTert=N'472',@grupa=NULL,@exc_grupa=NULL,@cFactura=NULL,@grfact=NULL,@lm=NULL,@comanda=NULL,@cont_cor=NULL,@tipinc=NULL,@indicator=NULL,@detTVA=N'1',@ordonare=N'1'