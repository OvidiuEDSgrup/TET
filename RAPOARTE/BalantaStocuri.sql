...
if exists (select 1 from sysobjects o where o.name='rapBalantaStocuri')
	drop procedure yso_rapBalantaStocuri
GO
--***
...
--	select @dDataJos='2012-01-01 00:00:00',@dDataSus='2012-05-16 00:00:00',@cCod=NULL,@cGestiune=NULL,@cCodi=NULL,@cCont=NULL,@TipStocuri=N'',@den=NULL,@gr_cod=NULL,@tip_pret=N'0',@tiprap=N'D'
--exec yso_rapBalantaStocuri @dDataJos=@dDataJos, @dDataSus=@dDataSus, @cCod=@cCod, @cGestiune=@cGestiune, @cCodi=@cCodi, @cCont=@cCont,
