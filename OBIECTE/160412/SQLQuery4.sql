...
;with antet as (
	...
	select a.tipS, a.dataS, a.numarS
		, isnull(p.col.value('(@idContractCorespondent)[1]','int'),a.idPozDocSursa) as idPozDocSursa
		, isnull(p.col.value('(@idContractCorespondent)[1]','int'),a.idPozDocStorno) as idPozDocStorno
	--into #pozStorno
