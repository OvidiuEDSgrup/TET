...
--ALTER PROCEDURE yso.DefalcTermeneBK @Subunitate CHAR(9), @Tip CHAR(2), @Contract CHAR(20), @Data DATETIME, @Tert CHAR(13) AS
...
,@Tert=Tert
,@Data=data
FROM pozcon where tip='bk' and Contract='1'
...
DECLARE	@lRezStocBK bit, @cListaGestRezStocBK CHAR(200)
	...
	,@StocGest FLOAT, @StocDisponibil FLOAT, @StocRezervat FLOAT, @TermenMaxim DATETIME
	,@cUM CHAR(1), @nZiScad SMALLINT, @amDatTermene smallint, @amTermene smallint, @dataCurenta date
	,@CantNecesara FLOAT, @CantDescStoc FLOAT, @CantDescContr FLOAT, @termenDescarcare DATETIME
	,@randuri INT
