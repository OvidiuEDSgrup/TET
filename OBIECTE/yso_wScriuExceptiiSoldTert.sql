if exists (select * from sysobjects where name ='yso_wScriuExceptiiSoldTert')
	drop procedure yso_wScriuExceptiiSoldTert
go

create procedure yso_wScriuExceptiiSoldTert @sesiune varchar(50), @parXML XML
as
