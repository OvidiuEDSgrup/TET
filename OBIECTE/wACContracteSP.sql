--***
if exists (select * from sysobjects where name ='wACContracteSP')
drop procedure wACContracteSP
go
--***
create procedure wACContracteSP @sesiune varchar(50), @parXML XML
as
...
/*sp*/,@tert=ISNULL(@parXML.value('(/row/@n_tert)[1]', 'varchar(20)'), @tert) /*sp*/
