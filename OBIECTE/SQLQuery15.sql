/****** Object:  StoredProcedure [dbo].[wScriuProprietati]    Script Date: 02/08/2012 20:42:41 ******/
SET ANSI_NULLS ON
GO
...
--***
CREATE
procedure [yso].[wScriuProprietati] @sesiune varchar(50), @parXML xml
as
...
--	scriere
	...
	select ptupdate, tip, cod, cod_proprietate, valoare, isnull(valoare_tupla,''), valoare_veche, isnull(valoare_tupla_veche,'')
