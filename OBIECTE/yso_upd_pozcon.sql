drop trigger [dbo].[yso_upd_pozcon]
go
CREATE trigger [dbo].[yso_upd_pozcon] on [dbo].[pozcon] instead of update as
...
UPDATE pozcon
 ...
 FROM pozcon
 INNER JOIN deleted d ON d.Subunitate=pozcon.Subunitate and d.Tip=d.Tip and d.Contract=pozcon.Contract and d.Data=pozcon.Data and d.Tert=pozcon.Tert
	and d.Cod=pozcon.Cod and d.Numar_pozitie=pozcon.Numar_pozitie
 INNER JOIN inserted i ON i.Subunitate= d.Subunitate AND i.tip= d.Tip AND i.Contract=d.Contract AND i.Tert= d.Tert AND i.Data= d.Data 
		and i.Cod= d.Cod and i.Numar_pozitie= d.Numar_pozitie
