/**
	Generare AP. GESTPV; LOCM;
	Generare PD (pozplin): cont-> PROP UTILIZ "CONTCASA". Data curenta.
	Listare formular cu procedura.
**/
if exists (select 1 from sysobjects where name='wOPStornareBonSP')
	drop procedure wOPStornareBonSP
go
