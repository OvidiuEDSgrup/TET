IF EXISTS (SELECT *	FROM sysobjects	WHERE NAME = 'yso_wIaFundamenteComanda')
	DROP PROCEDURE yso_wIaFundamenteComanda
GO
...
BEGIN TRY
	...
	**/
	...
	select distinct pn.idPozCon idPozContract, pt.idPozContract idPozContractCorespondent
	into #idpozc
	...
	where ct.tip='RN' and cn.idCon=@idContract 
