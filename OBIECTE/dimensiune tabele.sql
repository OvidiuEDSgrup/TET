...
create table #tbsize ([Name] sysname,Rows int,reserved varchar(18),Data varchar(18),index_size varchar(18),Unused varchar(18))
...
select * 
from #tbsize
order by [rows] desc-- convert(bigint, left(reserved,len(reserved)-3)) desc
