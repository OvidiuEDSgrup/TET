--***
if exists (select * from sysobjects where name ='yso_wACFacturiComisionate')
	drop procedure yso_wACFacturiComisionate
go
--***
...
begin
	select top 100 convert(char(20),f.Factura)+CONVERT(char(20),f.Tert) 
		as cod, 
