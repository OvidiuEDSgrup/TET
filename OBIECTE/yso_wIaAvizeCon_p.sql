IF EXISTS (SELECT * FROM sysobjects WHERE NAME = 'yso_wIaAvizeCon_p')
	DROP PROCEDURE yso_wIaAvizeCon_p
GO
CREATE PROCEDURE yso_wIaAvizeCon_p @sesiune VARCHAR(50), @parXML XML
AS
