...
--union all select 'T','Terti','CONTAGEST','Terti2','C',23.00,'','','<row><vechi><row id="23" nume="Terti" idparinte="2" icoana="Terti2" tipmacheta="C" meniu="T" modul=" " publicabil="1"/></vechi></row>',1
