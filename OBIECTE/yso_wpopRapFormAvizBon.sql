/**	Procedura de populare parametri pentru formularul web Factura
*/
--***
if exists (select 1 from sysobjects where name='yso_wpopRapFormAvizBon')
	drop procedure yso_wpopRapFormAvizBon
GO
--***
