/****** Object:  StoredProcedure [dbo].[wOPtemp]    Script Date: 04/30/2012 15:21:37 ******/

GO
drop procedure [dbo].[yso_wOPFormularPacheteBonPV]
GO
...
go
--declare @p2 xml
--set @p2=convert(xml,N'<parametri tip="BC" numar="1" data="04/05/2012" dengestiune="MAGAZIN AMANUNT NT" gestiune="211.1" dentert="ENE NECULAI" tert="1440301270581" factura="9410079" data_facturii="04/05/2012" valoare="0.48" tva="0.10" valtotala="0.48" numarpozitii="8" vanzator="MAGAZIN_NT" casam="1" ora="08:41" culoare="#0000EE" _nemodificabil="1" o_tip="BC" o_numar="1" o_data="04/05/2012" o_dengestiune="MAGAZIN AMANUNT NT" o_gestiune="211.1" o_dentert="ENE NECULAI" o_tert="1440301270581" o_factura="9410079" o_data_facturii="04/05/2012" o_valoare="0.48" o_tva="0.10" o_valtotala="0.48" o_numarpozitii="8" o_vanzator="MAGAZIN_NT" o_casam="1" o_ora="08:41" o_culoare="#0000EE" o__nemodificabil="1" update="1" nrform="0" tipMacheta="D" codMeniu="BO" TipDetaliere="BC" subtip="FP"/>')
--exec yso_wOPFormularPacheteBonPV @sesiune='8BA9ADE981205',@parXML=@p2