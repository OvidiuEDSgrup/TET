--***
if exists (select * from sysobjects where name ='yso_wIntegritateACPV')
drop procedure yso_wIntegritateACPV
go
--***
...
begin
	...
	*/
	...
	from #bp 
	where /*sp*/ @curefacere=2 or /*sp*/ abs(bp-ac)>=0.01 or abs(cantbp-cantpozdoc)>=0.001
...
go
 ...
 --exec yso_wIntegritateACPV '', '<row dataj="2012-09-11" datas="2012-09-11" curefacere="0"/>'
