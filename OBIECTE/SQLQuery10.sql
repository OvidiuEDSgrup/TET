...
--***
CREATE procedure [yso].[wStergTerti] @sesiune varchar(50), @parXML xml
as
...
begin try
	...
	delete pr
	from proprietati pr, #xmlterti x
	where pr.Tip='TERT' and pr.Cod_proprietate='SUBCONTRACTANT' and pr.Cod=x.tert
