--***
if exists (select * from sysobjects where name ='wIaPozBonuriSP')
drop procedure wIaPozBonuriSP
go
--***
create procedure wIaPozBonuriSP @sesiune varchar(50), @parXML xml  
as    
...
convert(decimal(5,2),d.Discount) as discount,
