...
rtrim(isnull((select top 1 cc.Denumire_cont from conturi cc, pozdoc p where d.tip not in ('RM', 'RS') and p.Subunitate=d.Subunitate and p.Tip=d.Tip and p.Numar=d.Numar and p.Data=d.Data and cc.Subunitate=p.Subunitate and cc.Cont=p.Cont_corespondent), ''))
 as dencontcorespondent,   
...
rtrim(isnull((select top 1 tcv.Denumire from terti tcv, pozdoc p where d.Tip='AI' and p.Subunitate=d.Subunitate and p.Tip=d.Tip and p.Numar=d.Numar and p.Data=d.Data and tcv.Subunitate=p.Subunitate and tcv.Tert=p.cont_venituri), isnull((select top 1 cc.De
numire_cont from conturi cc, pozdoc p where d.tip not in ('AI', 'PF', 'CI', 'AF') and p.Subunitate=d.Subunitate and p.Tip=d.Tip and p.Numar=d.Numar and p.Data=d.Data and cc.Subunitate=p.Subunitate and cc.Cont=p.Cont_venituri), ''))) as dencontvenituri,   
