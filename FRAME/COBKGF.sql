...
union all select 'CO','BK','GF','3','Generare factura',' ','','','','wOPGenerareUnAPdinBK','','','','','1','O','wOPGenerareUnAPdinBK_p',''
...
union all select 'CO','BK','GF','90','Eliberat','C','@eliberatbuletin','','150','1','1','','','','','','','','if (Number(row.@noudelegat)==1) {return row.@eliberatbuletin;} else {return String(row.@numedelegat).substr(62,30).replace(/^\s+|\s+$/g, '');}'
union all select 'CO','BK','GF','40','Nume delegat','AC','@iddelegat','@numedelegat','75','1','1','wACPersoaneContactSP','','','','Completati delegatul','','',''
union all select 'CO','BK','GF','99','Tip mijloc de transport','C','@mijloctp','@denmijloctp','100','0','1','','','','','','','','if (Number(row.@noumijltp)==1) {return row.@mijloctp;} else {return String(row.@denmijloctp).substr(10,30).replace(/^\s+|\s+$/g, '');}'
union all select 'CO','BK','GF','43','Adaug/Modific','CHB','@noudelegat','','100','1','1','','','','','','','',''
union all select 'CO','BK','GF','97','Adaug/Modific','CHB','@noumijltp','','100','0','1','','','','','','','',''
...
union all select 'CO','BK','GF','80','Numar Buletin','C','@numarbuletin','','100','1','1','','','','','','','','if (Number(row.@noudelegat)==1) {return row.@numarbuletin;} else {return String(row.@numedelegat).substr(53,9).replace(/^\s+|\s+$/g, '');}'
union all select 'CO','BK','GF','20','Factura','C','@numardoc','','100','1','1','','','','','Numar transfer','','',''
union all select 'CO','BK','GF','100','Observatii','C','@observatii','','300','1','1','','80','','','Observatii','','',''
union all select 'CO','BK','GF','120','Ora expedierii','C','@ora_expedierii','','75','0','1','','','','','','','',''
union all select 'CO','BK','GF','45','Prenume delegat','C','@prenumedelegat','','150','1','1','','','','','','','','if (Number(row.@noudelegat)==1) {return row.@prenumedelegat;} else {return String(row.@numedelegat).substr(20,30).replace(/^\s+|\s+$/g, '');}'
union all select 'CO','BK','GF','70','Serie Buletin','C','@seriebuletin','','100','1','1','','','','','','','','if (Number(row.@noudelegat)==1) {return row.@seriebuletin;} else {return String(row.@numedelegat).substr(50,3).replace(/^\s+|\s+$/g, '');}'