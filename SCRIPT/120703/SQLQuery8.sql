...
declare @Numar char(8) ,@Data datetime,@GestPred char(9),@GestPrim char(9),@GestDest char(20),  
 ...
 if isnull(@CodIPrim,'')=''  
  ...
  set @CodIPrim=dbo.cautareCodIntrare(isnull(@Cod,''),isnull(@GestPrim,''),@TipGestPrim,isnull(@CodIntrare,''),@PretSt,@PretAmPrim,isnull(@CtCoresp,''),@CodIPrimNou,0,'1901-01-01','1901-01-01','','',@Comanda,@ComLivr,'','')  
