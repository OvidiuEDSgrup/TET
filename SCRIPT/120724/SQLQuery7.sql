...
create procedure [dbo].[wValidareDocumentPVSP] @sesiune varchar(50), @parXML XML  
as  
declare @returnValue int  
set nocount on  
if exists(select * from sysobjects where name='yso_wValidareDocumentPVSP' and type='P')        
begin  
 exec @returnValue = yso_wValidareDocumentPVSP @sesiune,@parXML  
 return @returnValue   
end  
   ...
   update st   
    ...
    inner join   
     (select s.cod as cod, SUM(s.stoc) as stoc   
      ...
      where Subunitate=@subunitate /*startsp*/and s.stoc>0 /*stopsp*/  
